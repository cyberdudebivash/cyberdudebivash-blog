...
(function () {
  ...
  const SMART_CTA = {
    ...
    showOverlay(msg, trigger) {
      ...
      const overlay = el('div', { id: 'cx-smart-overlay' },
        ...
        el('div', { class: 'cx-badge' }, msg.badge || '⚡ SENTINEL APEX INTELLIGENCE'),
    ...
    injectInlineCTAs() {
      ...
      const ctaDefs = [
        ...
        },
        {
          ...
          sub: 'Access structured CVE data, IOC feeds, and risk scores via SENTINEL APEX API.',
  ...
  function boot() {
    ...
    setTimeout(() => {
      console.info('[SENTINEL APEX CX]', REVENUE_INTEL.getReport());
    }, 3000);
  }
